...
var repo_site = "https://minwenyang.github.io/qualtrics_columbia_card_task_cold/"
...
var getBoard = function(board_type) {
	...
	if (board_type == 2) {
		...
		board += "<div class = square><input type='image' class = card_image id = c" + i +
			" src='" +repo_site + "images/beforeChosen.png'></div>"
		}
...
var practiceSetup1 =
	"<div class = practiceText><div class = block-text2 id = instruct1><strong>Practice 1: </strong> In this game, you will choose the total number of cards you would like to turn over (from 0 to 32) and then continue to the next round.  If turning over any cards seems too risky to you can click the zero button, in which case your score for this round will automatically be zero.  This is a practice round, and it looks just like the game you will play.  Please select the number of cards you would like to turn over, given the number of loss cards and the amount that you can gain or lose if you turn over a gain or loss card, as shown below.  Please note: The computer will tell you how well you did after all " + numRounds + " game rounds are over!</div></div>" +
	"<div class = cct-box2>"+
...
var end_instructions = {
	...
	stimulus: '<div class = centerbox><p class = center-block-text><strong>End of Instructions </strong></p><p class = center-block-text>Press <strong>enter</strong> when you are ready to play the practice game.</p></div>',
	is_html: true,
	data: {
